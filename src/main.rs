...
fn main() {
    ...
    let choice: u128 = user_input::get_user_input("Choice");
    ...
    let update_every: u128 = user_input::get_user_input("After how many seconds do you want to update?");
    ...
    while distance_from_sun > 0.0 {
        ...
        if time as u128 % update_every == 0 {
